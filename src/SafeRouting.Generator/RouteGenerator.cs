...
public sealed class RouteGenerator : IIncrementalGenerator
{
  public void Initialize(IncrementalGeneratorInitializationContext context)
  {
    ...
    context.RegisterConditionalOutput(isGlobalUsingsSupportedProvider, static context => context.AddSource(
      "globalusings.g.cs",
      """
      // <auto-generated/>
  ...
  private static void RegisterControllerSourceOutput(
    IncrementalGeneratorInitializationContext context,
    IncrementalValuesProvider<CandidateClassInfo> candidateClassProvider,
  ...
  private static void RegisterPageSourceOutput(
    IncrementalGeneratorInitializationContext context,
    IncrementalValuesProvider<CandidateClassInfo> candidateClassProvider,
    IncrementalValueProvider<GeneratorOptions> optionsProvider
  )
